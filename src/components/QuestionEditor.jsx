            ...
            <div>
                <div className='flex justify-between mb-3'>
                    ...
                    <div className='flex items-center'>
                        <button
                            type="button"
                            className='flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white bg-gray-500 hover:bg-gray-700'
                                ...
                                <div>
                                    {model.data.options.map((op, index) => (
                                        <div key={index} className="flex items-center mb-1">
                                            ...
                                            <button
                                                type='button'
                                                className='h-6 w-6 ml-1 rounded-full flex items-center justify-center border border-transparent transition-colors hover:border-red-100'
